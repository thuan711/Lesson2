                        ...
                        if(count($subcategories) > 0) {
                            foreach($subcategories as $subcategory) {?>
                                <tr>
                                    ...
                                    <td style="color:#495057">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $subcategory['name'];?><i class="fa-regular fa-hand-back-point-right"></i></td>
                                    <td>
                                        <a class="p-2" href="<?php echo base_url; ?>editcate/<?php echo $subcategory['id']?>"><i class="fas fa-edit"></i></a><i class="fa-regular fa-hand-back-point-right"></i>
