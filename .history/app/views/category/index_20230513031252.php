                ...
                <?php foreach($data as $key=>$value){?> 
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url; ?>editcate/<?php echo $value['id']?>"><i class="fas fa-edit"></i><i class="fas fa-copy"></i></a>
                                <a href="<?php echo base_url; ?>delcate/<?php echo $value['id']?>"><input style="width:80px;" type="button" value="Xóa"><i class="fas fa-trash-alt"></i></a></li>
                            </td>
                        </tr>
                    </tbody>';
                <?php } ?>   
