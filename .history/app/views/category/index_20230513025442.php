...
<ul>
   ...
   <?php } ?> 
    ...
    <div class="container-fluid">
        <div class="row-title text-center" style="margin-left: 500px; font-size: 30px; color:#f1b0b7;">
                ...
                <?php foreach($data as $key=>$value){?> 
                    <tbody>
                        <tr>
                            ...
                            <!-- <td><a href="'.$suadm.'"><input style="width:80px;" type="button" value="Sửa" ></a> <a href="'.$xoadm.'"><input style="width:80px;" type="button" value="Xóa"></a></td> -->
                            <td>
                                <a href="<?php echo base_url; ?>editcate/<?php echo $value['id']?>"><input style="width:80px;" type="button" value="Sửa" ></a>
                                <a href="<?php echo base_url; ?>delcate/<?php echo $value['id']?>"><input style="width:80px;" type="button" value="Xóa"></a></li>
                            </td>
                        </tr>
                    </tbody>';
                <?php } ?>   
        ...
        <nav aria-label="Page navigation example alaign-center">
            <ul class="pagination">
