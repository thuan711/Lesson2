                ...
                <?php foreach($data as $key=>$value){?> 
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a class="p-3" href="<?php echo base_url; ?>editcate/<?php echo $value['id']?>"><i class="fas fa-edit"></i></a>
                                <a href="<?php echo base_url; ?>delcate/<?php echo $value['id']?>"><i class="fas fa-copy"></i></a>
                                <a href="<?php echo base_url; ?>delcate/<?php echo $value['id']?>"><i class="fas fa-trash-alt"></i></a>
                            </td>
                        </tr>
                    </tbody>';
                <?php } ?>   
