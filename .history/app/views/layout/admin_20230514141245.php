...
<head>
    <meta charset="UTF-8">
    <title><img src="<?php echo base_url; ?>public/image/logo-lam.jpg" alt="">PHP Intern</title>
...
<body>
    <div class="container-fluid p-0">
        <header>
            <div class="p-4">
                <ul class="nav nav-pills ml-5 h4 p-4 d-flex flex-row">
                    ...
                    <li class="nav-items ml-auto mr-5">
